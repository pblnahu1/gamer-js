  ...
  d.addEventListener('DOMContentLoaded', () => {
    fetch('assets/js/productos.json')
      ...
      .then(data => {
        ...
        let productos_favoritos_count = 0; // Incrementa en el ícono los productos agregados.
        ...
        const agregarAFavoritos = (boton, index) => {
          const producto = data[index];
          if (producto) {
            // Verificar si el producto ya está en favoritos
            let productoFavorito = d.getElementById(`id-prod-favorito-${index}`);
            if (productoFavorito) {
              // Mostrar una advertencia si el producto ya está en favoritos
              Swal.fire({
                title: 'Advertencia',
              ...
              // Crear una nueva entrada para el producto en favoritos
